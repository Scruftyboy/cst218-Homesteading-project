...
//     data: { userId: req.userId, email: req.email }
//   });
// });

// // Mount Entry routes
// app.use("/homesteadingEntries", entryRoutes);
...
// Health check
app.get("/", (req, res) => {
  res.status(200).json({ message: "Assignment 20 server is running" });
});

// Mount route groups
app.use("/auth", authRoutes);                    // → /auth/register, /auth/login
app.use("/entries", requireAuth, entryRoutes);   // all entries protected
